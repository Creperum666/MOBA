...
public class Level {
    ...
    public synchronized void movePlayer(String username, int x, int y, int numSteps, boolean isMoving, int movingDir, int health) {
    ...
    public synchronized void takeDamage(String username) {
    	int index = getPlayerMPIndex(username);
    	PlayerMP player = (PlayerMP) this.getEntities().get(index);
